...
namespace Fib.Net.Cli
{
    public abstract class Command
    {
        ...
        private IContainerizer GetContainerizer(FibCliConfiguration configuration, TextWriter output, TextWriter error)
        {
            var containerizer = CreateContainerizer(configuration);
            ...
            containerizer.AddEventHandler((IFibEvent e) =>
            {
                ...
                {
                    //output.WriteLine($"【{DateTime.Now:yyyy-MM-dd hh:mm:ss}】" + timerEvent.ToString());
                }
                else
                {
        ...
        protected abstract IContainerizer CreateContainerizer(FibCliConfiguration configuration);
    }
}